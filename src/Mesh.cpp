...
Mesh::Mesh(const std::vector<Triangle> &triangles, const Material &material, const Texture &texture) : triangles(triangles),
                                                                                                       bvh(triangles),
                                                                                                       material(material),
                                                                                                       texture(texture)
{
...
// 根据网格中三角形的面积进行随机采样
Point Mesh::sample(Point point) const
{
    int trycount = 0;
    Point temppoint;
